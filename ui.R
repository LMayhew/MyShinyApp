...
shinyUI(fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(
      checkboxInput("showModelOutputs","Show Model Outputs",value=FALSE),
    ...
    mainPanel(
       tabsetPanel(type="tabs",
          ...
          tabPanel("Documentation",br(),
                   ...
                   p("3. Check the Hurricane Katrina and/or Sandy buttons to see which
                     the windspeeds and damage of these two big hurricanes."),
                   p("4. Use the slider to select the years to limit the number
                     of points plotted and used in the model."),
                   p("5. Hover over a point to see the name of the hurricane."),
                   br(),
                   h4("About the Data..."),
